                ...
                <div className="resume-container">
                    <div className="info-resume-container">
                        ...
                        <div className="education-container">
                            ...
                            <div className="education-text">
                                <div className="flex">
                                    <div>
                                        <h4>Vivekananda Institute of Professional Studies, Delhi</h4>
                    ...
                    <div className="resume-img-box">
                        ...
                        <div className="social-links">
                            <a href="https://www.linkedin.com/in/rahul-shrestha-207674170" target="_blank" rel="noreferrer"><BsLinkedin/></a>
                            <a href="https://www.instagram.com/rahulshrestha14/" target="_blank" rel="noreferrer"><BsInstagram/></a>
                            {/* <a href="https://twitter.com/VirajMerai" target="_blank" rel="noreferrer"><AiFillTwitterCircle/></a> */}
                            <a href="https://github.com/MernRash" target="_blank" rel="noreferrer"><AiFillGithub/></a>
                        </div>
                    </div>
                </div>
            </div>
